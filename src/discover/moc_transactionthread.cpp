/****************************************************************************
** Meta object code from reading C++ file 'transactionthread.h'
**
...
#error "The header file 'transactionthread.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_TransactionThread[] = {
    "TransactionThread\0\0message\0"
    "transactionDone(QString)\0"
    "displayResult(QString)\0"
};
...
void TransactionThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->transactionDone((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->displayResult((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void TransactionThread::transactionDone(const QString & _t1)
{
...
// SIGNAL 1
void TransactionThread::displayResult(const QString & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
